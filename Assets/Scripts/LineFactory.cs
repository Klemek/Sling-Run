...
namespace SlingRun
{
    ...
    {
        public static GameObject createSimpleLine(GameObject defaultSprite, Vector3 p1, Vector3 p2, Color color,
            float thickness)
        {
            var center = (p1 + p2) / 2f;
            var tmp = p1 - p2;
        ...
        public static GameObject createDashedLine(GameObject defaultSprite, Vector3 p1, Vector3 p2, Color color,
